...
function generateSnapshot () {
  ...
  customRequire.definitions = {
    "./snapshot.js": function (exports, module, __filename, __dirname, require, define) {
      require("./node_modules/vue/dist/vue.runtime.common.js")
      require("./node_modules/vuex/dist/vuex.common.js")
    },
    "./node_modules/vue/dist/vue.runtime.common.js": function (exports, module, __filename, __dirname, require, define) {
      if (get_process().env.NODE_ENV === 'production') {
        module.exports = require("./node_modules/vue/dist/vue.runtime.common.prod.js")
      } else {
        module.exports = require("./node_modules/vue/dist/vue.runtime.common.dev.js")
      }

    },
    "./node_modules/vuex/dist/vuex.common.js": function (exports, module, __filename, __dirname, require, define) {
      /*!
       * vuex v3.6.2
       * (c) 2021 Evan You
       * @license MIT
      ...
      var target = typeof get_window() !== 'undefined'
        ? get_window()
        : typeof get_global() !== 'undefined'
          ? get_global()
          : {};
      ...
      var Store = function Store (options) {
        ...
        if (!Vue && typeof get_window() !== 'undefined' && get_window().Vue) {
          install(get_window().Vue);
        }
      ...
      Store.prototype.commit = function commit (_type, _payload, _options) {
        ...
        if (!entry) {
          if ((get_process().env.NODE_ENV !== 'production')) {
            get_console().error(("[vuex] unknown mutation type: " + type));
          }
          return
        }
        ...
        if (
          (get_process().env.NODE_ENV !== 'production') &&
      ...
      Store.prototype.dispatch = function dispatch (_type, _payload) {
        ...
        if (!entry) {
          if ((get_process().env.NODE_ENV !== 'production')) {
            get_console().error(("[vuex] unknown action type: " + type));
          }
          return
        }
        ...
        try {
          ...
          if ((get_process().env.NODE_ENV !== 'production')) {
            get_console().warn("[vuex] error in before action subscribers: ");
            get_console().error(e);
          }
        }
        ...
        return new Promise(function (resolve, reject) {
          result.then(function (res) {
            try {
              ...
              if ((get_process().env.NODE_ENV !== 'production')) {
                get_console().warn("[vuex] error in after action subscribers: ");
                get_console().error(e);
              }
            }
            resolve(res);
            ...
            try {
              ...
              if ((get_process().env.NODE_ENV !== 'production')) {
                get_console().warn("[vuex] error in error action subscribers: ");
                get_console().error(e);
              }
            }
            reject(error);
      ...
      function installModule (store, rootState, path, module, hot) {
        ...
        if (module.namespaced) {
          if (store._modulesNamespaceMap[namespace] && (get_process().env.NODE_ENV !== 'production')) {
            get_console().error(("[vuex] duplicate namespace " + namespace + " for the namespaced module " + (path.join('/'))));
          }
        ...
        var local = {
          dispatch: noNamespace ? store.dispatch : function (_type, _payload, _options) {
            ...
            if (!options || !options.root) {
              type = namespace + type;
              if ((get_process().env.NODE_ENV !== 'production') && !store._actions[type]) {
                get_console().error(("[vuex] unknown local action type: " + (args.type) + ", global type: " + type));
                return
              }
            }
          ...
          commit: noNamespace ? store.commit : function (_type, _payload, _options) {
            ...
            if (!options || !options.root) {
              type = namespace + type;
              if ((get_process().env.NODE_ENV !== 'production') && !store._mutations[type]) {
                get_console().error(("[vuex] unknown local mutation type: " + (args.type) + ", global type: " + type));
                return
              }
            }
      ...
      function registerGetter (store, type, rawGetter, local) {
        if (store._wrappedGetters[type]) {
          if ((get_process().env.NODE_ENV !== 'production')) {
            get_console().error(("[vuex] duplicate getter key: " + type));
          }
          return
        }
      ...
      var mapState = normalizeNamespace(function (namespace, states) {
        var res = {};
        if ((get_process().env.NODE_ENV !== 'production') && !isValidMap(states)) {
          get_console().error('[vuex] mapState: mapper parameter must be either an Array or an Object');
        }
      ...
      var mapMutations = normalizeNamespace(function (namespace, mutations) {
        var res = {};
        if ((get_process().env.NODE_ENV !== 'production') && !isValidMap(mutations)) {
          get_console().error('[vuex] mapMutations: mapper parameter must be either an Array or an Object');
        }
      ...
      var mapGetters = normalizeNamespace(function (namespace, getters) {
        var res = {};
        if ((get_process().env.NODE_ENV !== 'production') && !isValidMap(getters)) {
          get_console().error('[vuex] mapGetters: mapper parameter must be either an Array or an Object');
        }
        normalizeMap(getters).forEach(function (ref) {
          ...
          res[key] = function mappedGetter () {
            ...
            if ((get_process().env.NODE_ENV !== 'production') && !(val in this.$store.getters)) {
              get_console().error(("[vuex] unknown getter: " + val));
              return
            }
      ...
      var mapActions = normalizeNamespace(function (namespace, actions) {
        var res = {};
        if ((get_process().env.NODE_ENV !== 'production') && !isValidMap(actions)) {
          get_console().error('[vuex] mapActions: mapper parameter must be either an Array or an Object');
        }
      ...
      function getModuleByNamespace (store, helper, namespace) {
        ...
        if ((get_process().env.NODE_ENV !== 'production') && !module) {
          get_console().error(("[vuex] module namespace not found in " + helper + "(): " + namespace));
        }
        return module
      }
      ...
      function createLogger (ref) {
        ...
        var logger = ref.logger; if ( logger === void 0 ) logger = get_console();
    ...
    "./node_modules/vue/dist/vue.runtime.common.dev.js": function (exports, module, __filename, __dirname, require, define) {
      ...
      var inBrowser = typeof get_window() !== 'undefined';
      var inWeex = typeof WXEnvironment !== 'undefined' && !!WXEnvironment.platform;
      var weexPlatform = inWeex && WXEnvironment.platform.toLowerCase();
      var UA = inBrowser && get_window().navigator.userAgent.toLowerCase();
      ...
      if (inBrowser) {
        try {
          ...
          get_window().addEventListener('test-passive', null, opts);
        } catch (e) {}
      }
      ...
      var isServerRendering = function () {
        if (_isServer === undefined) {
          /* istanbul ignore if */
          if (!inBrowser && !inWeex && typeof get_global() !== 'undefined') {
            // detect presence of vue-server-renderer and avoid
            // Webpack shimming the process
            _isServer = get_global()['process'] && get_global()['process'].env.VUE_ENV === 'server';
          } else {
            _isServer = false;
          }
        }
      ...
      // detect devtools
      var devtools = inBrowser && get_window().__VUE_DEVTOOLS_GLOBAL_HOOK__;
      ...
      {
        var hasConsole = typeof get_console() !== 'undefined';
        ...
        warn = function (msg, vm) {
          ...
          if (config.warnHandler) {
            ...
            get_console().error(("[Vue warn]: " + msg + trace));
          }
        };

        tip = function (msg, vm) {
          if (hasConsole && (!config.silent)) {
            get_console().warn("[Vue tip]: " + msg + (
      ...
      function logError (err, vm, info) {
        ...
        if ((inBrowser || inWeex) && typeof get_console() !== 'undefined') {
          get_console().error(err);
        } else {
          throw err
        }
      }
      ...
      if (typeof Promise !== 'undefined' && isNative(Promise)) {
        ...
        var textNode = get_document().createTextNode(String(counter));
      ...
      {
        var perf = inBrowser && get_window().performance;
        /* istanbul ignore if */
        if (
          perf &&
          perf.mark &&
      ...
      if (inBrowser && !isIE) {
        var performance = get_window().performance;
        if (
          performance &&
          typeof performance.now === 'function' &&
          getNow() > get_document().createEvent('Event').timeStamp
        ) {
      ...
      function isUnknownElement (tag) {
        ...
        var el = get_document().createElement(tag);
        if (tag.indexOf('-') > -1) {
          // http://stackoverflow.com/a/28210364/1070244
          return unknownElementCache[tag] = (
            el.constructor === get_window().HTMLUnknownElement ||
            el.constructor === get_window().HTMLElement
          );
        } else {
      ...
      function query (el) {
        if (typeof el === 'string') {
          var selected = get_document().querySelector(el);
          if (!selected) {
            warn(
              'Cannot find element: ' + el
            );
            return get_document().createElement('div');
          }
          return selected
        } else {
          return el
      ...
      function createElement$1 (tagName, vnode) {
        var elm = get_document().createElement(tagName);
        if (tagName !== 'select') {
          return elm
        }
      ...
      function createElementNS (namespace, tagName) {
        return get_document().createElementNS(namespaceMap[namespace], tagName);
      }

      function createTextNode (text) {
        return get_document().createTextNode(text);
      }

      function createComment (text) {
        return get_document().createComment(text);
      }
                ...
                if (isDef(i = data) && isDef(i = i.domProps) && isDef(i = i.innerHTML)) {
                  if (i !== elm.innerHTML) {
                    ...
                    if (typeof get_console() !== 'undefined' &&
                      ...
                      get_console().warn('Parent: ', elm);
                      get_console().warn('server innerHTML: ', i);
                      get_console().warn('client innerHTML: ', elm.innerHTML);
                    }
                    return false
                  }
                } else {
                  ...
                  if (!childrenMatch || childNode) {
                    ...
                    if (typeof get_console() !== 'undefined' &&
                      ...
                      hydrationBailed = true;
                      get_console().warn('Parent: ', elm);
                      get_console().warn('Mismatching childNodes vs. VNodes: ', elm.childNodes, children);
                    }
                    return false
                  }
                }
        ...
        if (useMicrotaskFix) {
          ...
          handler = original._wrapper = function (e) {
            if (
              ...
              // starting reference
              e.target.ownerDocument !== get_document()
            ) {
      ...
      function updateDOMProps (oldVnode, vnode) {
        ...
        for (key in props) {
          ...
          if (key === 'value' && elm.tagName !== 'PROGRESS') {
            ...
            svgContainer = svgContainer || get_document().createElement('div');
      ...
      function isNotInFocusAndDirty (elm, checkVal) {
        ...
        try { notInFocus = get_document().activeElement !== elm; } catch (e) {}
      ...
      var normalize = cached(function (prop) {
        emptyStyle = emptyStyle || get_document().createElement('div').style;
        prop = camelize(prop);
      ...
      if (hasTransition) {
        /* istanbul ignore if */
        if (get_window().ontransitionend === undefined &&
          get_window().onwebkittransitionend !== undefined
        ) {
          transitionProp = 'WebkitTransition';
          transitionEndEvent = 'webkitTransitionEnd';
        }
        if (get_window().onanimationend === undefined &&
          get_window().onwebkitanimationend !== undefined
        ) {
      ...
      var raf = inBrowser
        ? get_window().requestAnimationFrame
          ? get_window().requestAnimationFrame.bind(get_window())
          : setTimeout
      ...
      function getTransitionInfo (el, expectedType) {
        var styles = get_window().getComputedStyle(el);
      ...
      if (isIE9) {
        ...
        get_document().addEventListener('selectionchange', function () {
          var el = get_document().activeElement;
          if (el && el.vmodel) {
            trigger(el, 'input');
          }
        });
      ...
      function trigger (el, type) {
        var e = get_document().createEvent('HTMLEvents');
      ...
      var TransitionGroup = {
        ...
        updated: function updated () {
          ...
          // $flow-disable-line
          this._reflow = get_document().body.offsetHeight;
        ...
        setTimeout(function () {
          if (config.devtools) {
            if (devtools) {
              ...
              get_console()[get_console().info ? 'info' : 'log'](
...
snapshotAuxiliaryData.snapshotSections = [{"relativePath":"./snapshot.js","startRow":277,"endRow":279},{"relativePath":"./node_modules/vue/dist/vue.runtime.common.js","startRow":281,"endRow":287},{"relativePath":"./node_modules/vuex/dist/vuex.common.js","startRow":289,"endRow":1534},{"relativePath":"./node_modules/vue/dist/vue.runtime.common.prod.js","startRow":1536,"endRow":1542},{"relativePath":"./node_modules/vue/dist/vue.runtime.common.dev.js","startRow":1544,"endRow":9968}]
